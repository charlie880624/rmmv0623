...
//=============================================================================
 /*:
* @plugindesc 【Yep系列】主選單指令管理插件|功能類
  * @author Yanfly Engine Plugins 漢化:碩明雲書
  *
  * @param ---Command---
  * @text ----命令----
  * @default
...
* 【yep雲漢版】
  ...
  * 更改主選單命令的各個方面插件
  * 無需觸摸原始程式碼即可使用此插件
  * 可搭配:gameusquestsystem.js[進階任務插件]使用
  * =================================================== =============================
  * ▶如何使用此插件 (～￣▽￣)～
  * =================================================== = ============================
  *
  * 參數中的每個部分都被分割為不同的部分。 每個
  * 這些部分在選單命令的工作方式中運作。
  *
  * Name
  * -這是命令在主選單中的顯示文字
  *
  * Symbol
  * -這是命令的識別碼。 每個指令都應具有唯一的
  * 符號，以避免與每個命令發生衝突（公共事件）
  * Show
  * -這是指令是否顯示在主選單。
  *
  * Enabled
